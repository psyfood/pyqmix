# -*- coding: utf-8 -*-
#
# pphelper documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('../../pyqmix'))
...
project = u'pyqmix'
copyright = u'2018, Lorenzo Alfine, Camilla Arndal Andersen, & Richard Höchenberger.'
...
version = pyqmix.__version__
# The full version, including alpha/beta/rc tags.
release = pyqmix.__version__
